...
if check_gpus():
    def parse(line,qargs):
        ...
        power_manage_enable=lambda v:(not 'Not Support' in v)#lambda expr，checking power management support
        to_numberic=lambda v:float(v.upper().strip().replace('MIB','').replace('W',''))#eliminate units
